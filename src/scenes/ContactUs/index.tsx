...
const ContactUs = ({ setSelectedPage }: Props) => {
  ...
  return (
    <section id="contactus" className="mx-auto mb-32 w-5/6 pt-24 ">
      <motion.div
      ...
      >
        ...
        >
          ...
          <p className="my-5">
            ...
            veritatis pariatur, eum sunt dolorum dignissimos facere autem nemo
            unde?
          </p>
        </motion.div>
        ...
        <div className="mt-10 justify-between gap-8 md:flex">
          ...
          >
            <form
              ...
              onSubmit={onSubmit}
              target="_blank"
              action="https://formsubmit.co/d3979af8b68cdf7c9e1a6e75192413f8"
            >
              {/* FIRST INPUT */}
              <input
                type="text"
